                ...
                <div>
                    ...
                    <div className={classes.Form}>
                        <div className={classes.LockIcon}>
                            <FontAwesomeIcon icon={faUnlockAlt} size='2x' style={{color: 'white'}}/>
                        </div>
                        <h2>Sign in</h2>
                        <form onSubmit={this.submitHandler}>
                            ...
                            <NavLink to='/signup' className={classes.SignUp}>Don't have an account? Sign Up</NavLink>         
                        </form>
...
const mapDispatchToProps = dispatch => {
    return {
        onSignInAuth : (email, password) => dispatch(actions.signInAuth(email, password))        
    }
}
